---
tipo: investigacao_principal
status: em_busca_de_batismo
nome_completo: Maria Guilhermina Brandi
aliases:
  - Maria Baptista Brande de Ribeiro
...
pai_provavel: "[[Pai_Nicola Brandi|Nicola Brandi]]"
mae_provavel: "[[Mãe_Anna Silvéria de Jesus|Anna Silvéria de Paula Pereira]]"
conjuge: Paulino José dos Santos
nascimento_estimado: "1862–1863"
viva_pelo_menos_ate: 1919
localidade_foco: "Baependi, MG"
tags: [investigacao_ativa, pessoa_buscada, brandi, baependi]
---

# 🔍 Maria Guilhermina Brandi — Investigação Principal
...
Maria Guilhermina Brandi é a pessoa central desta investigação. Ela é mãe de pelo menos **13 filhos/registros** documentados em Baependi, MG, entre 1879 e 1898, com o marido **Paulino José dos Santos**.

Ela é filha provável do imigrante italiano [[Pai_Nicola Brandi|Nicola Brandi]] e de [[Mãe_Anna Silvéria de Jesus|Anna Silvéria de Paula Pereira]].

---

## 👨‍👩‍👧‍👦 Filhos e Descendentes Identificados

| Nome | Evento | Data | Fonte |
|------|--------|------|-------|
...
## ⚠️ Variações de Nome Encontradas

Esta é uma **pista crítica** — o nome aparece de formas muito diferentes nos registros:

| Variação | Encontrada em |
|----------|--------------|
| **Maria Guilhermina Brandi** | Batismos Nicolão, Paulino, Antonio, Lindolpho |
| **Maria Baptista Brande de Ribeiro** | Batismo de Matildes (1882) |
...
| **Maria Guilhermina de Jesus** | Casamento do filho Antonio (1933) — **forma mais usada em vida** |

> 💡 Ao buscar o batismo dela, testar **todas** essas variações.

---

## 🗺️ Localidades Associadas

| Cidade | Estado | Relevância |
|--------|--------|-----------|
| **Baependi** | MG | 🎯 **PRIORIDADE MÁXIMA** — paróquia confirmada (casamento dos pais 1861, Gervazia 1865, Custódio 1882) |
| **Pouso Alto** | MG | 2ª opção — possível alternativa, prioridade menor |
| **Piracicaba** | MG | Mencionada no óbito de Manoel |
| **Andrelândia** | MG | Registro de Paulo (1912) — família migrou |
| **Campanha** | MG | Casamento de Maria Paulina (1936) — 3ª geração |
| **Jacareí** | SP | Óbito do irmão Custódio (1941) — migração para SP |

---

## ⏳ Linha do Tempo da Vida (o que sabemos)

| Período | Evento | Confirmado? |
|---------|--------|-------------|
| **1862–1863** | Nascimento (estimado — antes de Gervazia, 17/02/1864) | ⚠️ Estimativa refinada |
...
## 👶 Como Madrinha de Netos

Maria Guilhermina foi madrinha de batismo de pelo menos **dois netos/afilhados** confirmados, e aparece como madrinha até **1919**.

> ⚠️ **A identificar:** Quais outros netos ela apadrinhou? Cada registro onde ela aparece como madrinha confirma que estava viva naquela data.
...
> 🔍 **Nicolau Brandi** (padrinho de Moyses, 1918) — o bebê foi batizado como "Moyses **Brandi** Barbosa da Silva" — o sobrenome Brandi no nome do bebê homenageia a família. O padrinho "Nicolau Brandi" ao lado de Maria Guilhermina indica relação familiar próxima. Hipótese mais provável: **Nicolau Brandi filho de Moyses Brandi** (sobrinho de Maria Guilhermina) — ele seria filho do irmão dela, chamando o bebê com o nome do avô Moyses.

---

## 🔎 Próximos Passos

👉 Ver: [[Estratégia de Busca - Maria Guilhermina]]
